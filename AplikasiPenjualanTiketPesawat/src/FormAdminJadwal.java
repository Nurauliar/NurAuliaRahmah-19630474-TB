...
public class FormAdminJadwal extends javax.swing.JFrame {

    /**
     * Creates new form FormAdminJadwal
     */
    ...
    private void initComponents() {
        ...
        btnCetak.setBackground(new java.awt.Color(102, 153, 255));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormAdminJadwal.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new FormAdminJadwal().setVisible(true);
